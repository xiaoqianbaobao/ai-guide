...
- 如果你已经会基础公式，建议从 [第3章](./chapter-03-self-attention-qkv) 和 [第3.5章](./chapter-03b-attention-matrix-and-code) 开始，再补 [第1章](./chapter-01-why-transformer) 和 [第6章](./chapter-06-training-inference-and-evolution)。
