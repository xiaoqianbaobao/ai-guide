...
description: Transformer 相关内容已拆成 6 章连续专题，这里作为总览和阅读入口
module: llm
tags:
  - 总览
  - Transformer
...
<ArticleHeader
  ...
  summary="这一页不再承担完整的 Transformer 讲解，而是作为专题总入口。Transformer 相关内容已经拆成 6 章，从范式切换、输入表示、QKV，到 BERT/GPT、KV Cache 与现代演化，形成连续阅读路线。"
/>
...
- 如果你已经会基础公式，建议从 [第3章](./chapter-03-self-attention-qkv) 开始，再补 [第1章](./chapter-01-why-transformer) 和 [第6章](./chapter-06-training-inference-and-evolution)。
- 如果你更关心后面的 Agent 工程，建议至少读完 [第2章](./chapter-02-token-embedding-position)、[第3章](./chapter-03-self-attention-qkv)、[第6章](./chapter-06-training-inference-and-evolution)。
