---
title: "DeerFlow Harness 深度拆解：Agent 运行时引擎的完整架构设计"
...
22. [Agent 面试 / JD 知识点映射](#22-agent-面试--jd-知识点映射)
...
![架构图](architecture-checkpointer-flow.png)
...
![架构图](architecture-tool-loading.png)

![架构图](architecture-m5-identity.png)
...
![架构图](architecture-serialization.png)
...
![架构图](architecture-subagent-memory.png)
